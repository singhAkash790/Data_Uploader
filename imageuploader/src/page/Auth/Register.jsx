        ...
        <div class="w-full flex-1 mt-8">
          ...
          <div class="mx-auto max-w-xs">
            ...
            <p class="mt-6 text-xs text-gray-600 text-center">
              ...
              <a href="/error" class="border-b border-gray-500 border-dotted">
                Terms of Service
              </a>
              and its
              <a href="/error" class="border-b border-gray-500 border-dotted">
  ...
  <div class="REMOVE-THIS-ELEMENT-IF-YOU-ARE-USING-THIS-PAGE hidden treact-popup fixed inset-0 flex items-center justify-center">
      <div class="max-w-lg p-8 sm:pb-4 bg-white rounded shadow-lg text-center sm:text-left">
        ...
        <div class="mt-8 pt-8 sm:pt-4 border-t -mx-8 px-8 flex flex-col sm:flex-row justify-end leading-relaxed">
          ...
          <a class="font-bold mt-4 sm:mt-0 sm:ml-4 px-8 py-3 sm:py-2 rounded bg-purple-700 text-gray-100 hover:bg-purple-900 transition duration-300 text-center" href="https://treact.owaiskhan.me" target="_blank" rel="noreferrer">See Treact</a>
        </div>
      </div>
    </div>
</div>
